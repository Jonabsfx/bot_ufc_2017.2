...
def check(days_left):
    if int(days_left) >= 0:
        return f'O semestre de {TODAY.year}.2 da UFC acaba em {days_left} dias.'
    return strings.HORN + f'O semestre de {TODAY.year}.2 da UFC acabou' + strings.PALM_TREE
